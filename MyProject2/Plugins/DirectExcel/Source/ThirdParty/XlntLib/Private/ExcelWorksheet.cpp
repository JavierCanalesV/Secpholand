...
UExcelCell* UExcelWorksheet::FindBoolAtColumn(int32 columnIndex, bool searchValue) const
{
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindIntAtColumn(int32 columnIndex, int32 searchValue) const
{
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindFloatAtColumn(int32 columnIndex, float searchValue) const
{
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindStringAtColumn(int32 columnIndex, FString searchValue) const
{
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindDateTimeAtColumn(int32 columnIndex, FDateTime searchValue) const
{
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindBoolAtColumnString(FString columnString, bool searchValue) const
{
	int32 columnIndex = UExcelCellReferenceLibrary::ToColumnIndex(columnString);
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindIntAtColumnString(FString columnString, int32 searchValue) const
{
	int32 columnIndex = UExcelCellReferenceLibrary::ToColumnIndex(columnString);
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindFloatAtColumnString(FString columnString, float searchValue) const
{
	int32 columnIndex = UExcelCellReferenceLibrary::ToColumnIndex(columnString);
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindStringAtColumnString(FString columnString, FString searchValue) const
{
	int32 columnIndex = UExcelCellReferenceLibrary::ToColumnIndex(columnString);
	return FindCellAtColumn(columnIndex, searchValue);
...
UExcelCell* UExcelWorksheet::FindDateTimeAtColumnString(FString columnString, FDateTime searchValue) const
{
	int32 columnIndex = UExcelCellReferenceLibrary::ToColumnIndex(columnString);
	return FindCellAtColumn(columnIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindBoolAtRow(int32 rowIndex, bool searchValue) const
{
	return FindCellAtRow(rowIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindIntAtRow(int32 rowIndex, int32 searchValue) const
{
	return FindCellAtRow(rowIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindFloatAtRow(int32 rowIndex, float searchValue) const
{
	return FindCellAtRow(rowIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindStringAtRow(int32 rowIndex, FString searchValue) const
{
	return FindCellAtRow(rowIndex, searchValue);
}

UExcelCell* UExcelWorksheet::FindDateTimeAtRow(int32 rowIndex, FDateTime searchValue) const
{
	return FindCellAtRow(rowIndex, searchValue);
}
