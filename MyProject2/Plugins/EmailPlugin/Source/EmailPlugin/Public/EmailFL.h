...
public:
	 ...
	 *@param EmailDetailAsset A reference to an email detail asset. It can be created in the content browser under Miscellaneous
	 ...
	 *@param EmailDetailAsset A reference to the email details asset to query
	 ...
	 *@param Attachment The attachment file to reference in the <img> tag
	 *@param Size The size the image will be diplayed at in pixels
	...
	/**
	 *Constructs an HTML <img> tag which references a URL. Optionally adds a number of <br> tags before and after the image.
	 *@param URL The url to reference in the <img> tag
	 *@param Size The size the image will be diplayed at in pixels
	 *@param NumSpacesBeforePic Optional number of spaces before the image.
	 *@param NumSpacesAfterPic Optional number of spaces after the image
	 */
	 ...
	 *@param Text The string that should be split into lines using LINE_TERMINATORs
